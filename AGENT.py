...
║  → Baca file AGENTS.md di root project untuk panduan kerja AI             ║
║  → Workflow: Update lokal → Test → Push → CI/CD → Analisa jika gagal      ║
║                                                                            ║
...
def run_tests():
    ...
    print("="*70)
    print("📋 Lihat AGENTS.md untuk aturan pengembangan AI")
    print("="*70 + "\n")
